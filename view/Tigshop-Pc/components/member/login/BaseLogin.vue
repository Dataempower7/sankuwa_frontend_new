            ...
            <template v-if="loginType == 1">
                <div class="login-main">
                    ...
                    <div class="login-body">
                        ...
                        <template v-if="showOauth === 1 && commonStore.openWechatOauth === 1 && commonStore.openWechatRegister === 1">
                    ...
                    <template v-if="commonStore.openWechatOauth === 1 && commonStore.openWechatRegister === 1">

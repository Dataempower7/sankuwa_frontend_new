<template>
    <div class="product_info">
        ...
        <div class="basic">
            ...
            <!--            <div class="item">-->
            <!--                <div class="tit">{{$t('送货至')}}：</div>-->
            <!--                <div class="address">-->
            <!--                    <SelectRegion v-model="regionIds" @change="onRegionIdsChange"></SelectRegion>-->
            <!--                </div>-->
            <!--            </div>-->
        ...
        <div class="actions" :class="{ 'no-border': isB2B() && skuList.length > 1 }">
...
onMounted(() => {
    ...
    maxProductNumber.value = 0;
});

const onRegionIdsChange = () => {
    const productRegionIds = useCookie<any[]>("productRegionIds");
    productRegionIds.value = regionIds.value;
};

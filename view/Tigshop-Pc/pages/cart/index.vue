            ...
            <div>
                ...
                <div v-if="cartList" class="cart_table" v-for="(item, index) in cartList">
                    ...
                    <div class="cart_list_wrap">
                        <div class="product-list-cart" v-for="product in item.carts"
                            :class="isDisabledData(product) ? 'disabled-item' : ''">
                            <div class="product-item flex">
                                <div class="item col-1 center flex align-center justify-center">
                                    <el-checkbox v-model="product.isChecked" @change="onChangeCheck()"
                                        :disabled="isDisabledData(product)"> </el-checkbox>
                                </div>
                                <div class="item col-4 flex">
                                    <div class="pic">
                                        <a v-if="product.stock != 0 && product.productStatus != 0" target="_blank"
                                            :href="urlFormat({
                                                path: 'product',
                                        ...
                                        <div class="disabled"
                                            v-if="(product.stock == 0 || product.productStatus == 0) && product.isDisabled == true">
                                    ...
                                    <div class="name pt5">
                                        ...
                                        <div class="info">
                                            <span v-for="(sku, _index) in product.skuData"> {{ _index !== 0 ? " , " : ""
                                                ...
                                                <template v-for="attr in product.extraSkuData" :key="attr">
                                                    <div class="extraskudata-item">
                                                        ...
                                                        <div class="content">
                                                            ...
                                                            <FormatPrice v-model="attr.attrPrice" :showText="false">
                                                            </FormatPrice>
                                        ...
                                        <template v-if="product.activityInfo">
                                            <div class="promotion-box">
                                                <div class="promotion-box-item"
                                                    ...
                                                    <div class="promotion" v-if="subItem.type == 2">
                                                        <div class="ticket-type">{{ $t("券") }}<span
                                                                class="ticket-line"></span></div>
                                                        <div class="ticket-content">{{ subItem.data.promotionDesc }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="item col-2 center">
                                    <div class="pt5 flex justify-center">
                                        <InputNumber :max="product.stock" v-model="product.quantity"
                                            @change="handleUpdateCartItem(product)" :disabled="isDisabledData(product)">
                                        </InputNumber>
                                    </div>
                                </div>
                                <div class="item col-2 center">
                        ...
                        <div class="gift-box">
                            ...
                            <div class="gift-content">
                                <template v-for="subItem in item.gift" :key="subItem.giftId">
                                    <NuxtLink target="_blank" :to="urlFormat({
                                        path: 'product',
                                        ...
                                        <div class="gift-content-item">
                                            <div class="gift-item-left">
                                                <el-image class="gift-img" lazy :src="imageFormat(subItem.picThumb)">
                                                </el-image>
                                            </div>
                                            <div class="gift-item-right">
                                                ...
                                                <template v-if="subItem.skuData.length > 0">
                                                    <div class="sku-card">
                                                        <template v-for="(skuItem, skuIndex) in subItem.skuData"
                                                            :key="skuIndex">
                            ...
                            <div class="pay_tools_r flex align-center">
                                <div class="pay_tools_total_box">
                                    ...
                                    <div class="discounts-btn-box">
                                        <div>{{ $t("共优惠") }}：<FormatPrice v-model="total.discounts" :showText="false">
                                            </FormatPrice>
                                        </div>
                                        ...
                                        <CommonPopover v-model="showDiscountInfo">
                                            <template #reference>
                                                <div class="discounts-btn">
                                                    {{ $t("优惠明细") }}
                                                    <span class="iconfont-pc icon-shangjiantou"
                                                        :class="{ 'icon-active': showDiscountInfo }"></span>
                                                </div>
                                            </template>
                                            <template #default>
                                                <div class="discount">
                                                    ...
                                                    <div class="discount-content">
                                                        <div class="discount-item-box">
                                                            ...
                                                            <div class="item-value">
                                                                <FormatPrice :showText="false"
                                                                    v-model="total.productAmount"
                                                                    :fontStyle="{ fontWeight: 'bold' }"></FormatPrice>
                                                            </div>
                                                        </div>
                                                        <div class="discount-item-box"
                                                            v-if="total.serviceFee && total.serviceFee > 0">
                                                            <div class="item-label">{{ $t("附加费用") }}</div>
                                                            <div class="item-value">
                                                                <FormatPrice v-model="total.serviceFee"
                                                                    :fontStyle="{ fontWeight: 'bold' }"
                                                                    :showText="false"></FormatPrice>
                                                            </div>
                                                        </div>
                                                        <div class="discount-item-box">
                                                            <div class="item-label">{{ $t("共优惠") }}</div>
                                                            <div class="item-value discounts-value"
                                                                style="color: var(--general)">
                                                                -
                                                                <FormatPrice v-model="total.discounts"
                                                                    :showText="false"></FormatPrice>
                                                            </div>
                                                            ...
                                                            <div class="sub-item-box"
                                                                v-if="total.discountDiscountAmount > 0">
                                                                <!-- <div class="sub-item-label">{{ $t("其他优惠") }}</div> -->
                                                                <div class="sub-item-label">{{ $t("活动优惠") }}</div>
                                                                <div class="sub-item-value discounts-value">
                                                                    -
                                                                    <FormatPrice v-model="total.discountDiscountAmount"
                                                                        :showText="false"></FormatPrice>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="discount-detail"
                                                            v-if="total.discountCouponAmount > 0">
                                                            <div class="sub-item-label">{{ $t("优惠券") }}</div>
                                                            <div class="sub-item-value discounts-value">
                                                                -
                                                                <FormatPrice v-model="total.discountCouponAmount"
                                                                    :showText="false"></FormatPrice>
                                                            </div>
                                                        </div>
                                                        <div class="discount-item-box">
                                                            ...
                                                            <div class="item-value">
                                                                <FormatPrice v-model="total.discountAfter"
                                                                    :fontStyle="{ fontWeight: 'bold' }"
                                                                    :showText="false"></FormatPrice>
                                                            </div>
                                                        </div>
                                                        <div class="discount-desc">{{ $t("以上优惠不包含运费，实际优惠金额请以确认订单页为准") }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </template>
                                ...
                                <div @click="total.checkedCount && toCheck()"

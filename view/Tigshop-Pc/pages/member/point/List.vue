<template>
    ...
    <CommonHeader title="积分明细"></CommonHeader>
                ...
                <table class="custom-table">
                    <thead class="table-header">
                        <tr>
                            ...
                            <th class="header-cell" style="width: 80px">{{ $t("积分") }}</th>
                    ...
                    <tbody v-else>
                        <tr>
                            <td v-if="!loading" class="no-table-result" colspan="4">{{ $t("您还没有积分明细") }}</td>
                    ...
                    <tfoot class="table-footer">
                        <tr>
                            <td colspan="4">
                                {{ $t("您的当前积分为") }}：<span class="font-color">{{ userPoints }}</span>
                            </td>
                        </tr>
                    </tfoot>
                </table>

<template>
    <div>
        <CommonHeader title="YabandPay"></CommonHeader>
        ...
        <div class="wechat-com">
            <div class="wechat container">
                ...
                <div class="message">
                    {{ $t("应付金额") }}：
                    <FormatPrice v-model="order.totalAmount" :fontStyle="{ color: 'var(--price)', fontSize: '18px' }"></FormatPrice>
                </div>
                <div class="payment">

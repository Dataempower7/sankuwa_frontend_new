<template>
    <div style="background-color: #fff">
        ...
        <div class="container">
            ...
            <CommonCatGoodsList v-model:queryParams="queryParams" v-model:filter="filter" @change="onFilterChange" @pageChange="onPageChange" />
        </div>
...
watchEffect(() => {
    ...
    filter.maxPrice = route.query.max ? Number(route.query.max) : 0;
    filter.minPrice = route.query.min ? Number(route.query.min) : 0;

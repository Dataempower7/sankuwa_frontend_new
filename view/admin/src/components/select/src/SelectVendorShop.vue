<template>
    <el-select v-model="shopId" :loading="loading" filterable :multiple="props.multiple"
        :placeholder="isStore() ? '请输入门店名称' : '请输入店铺名称'" clearable reserve-keyword @change="onChange">

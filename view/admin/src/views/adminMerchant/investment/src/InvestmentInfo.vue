            ...
            <div class="lyecs-form-table">
                <el-form v-if="!loading" ref="formRef" :model="formState" label-width="auto">
                    <el-form-item :rules="[{ required: true, message: '流程标题不能为空!' }]" label="流程标题" prop="title">
                        ...
                        <BusinessData v-model:modelValue="formState.title" :dataType="13" classType="tig-form-input"></BusinessData>
                    </el-form-item>
                    <el-form-item v-if="decorateSn == 'investmentPromotionHomepage' && index != 0" label="流程图" prop="image">
                        <FormAddGallery v-model:photo="formState.image" pageType="overseas" :dataType="13"></FormAddGallery>
                    ...
                    <el-form-item v-if="decorateSn == 'investmentPromotionHomepage' && index == 0" label="轮播图" prop="images">
                        <PicList :isMultiple="true" v-model:photos="formState.images" pageType="overseas" :dataType="13"></PicList>
                        <div class="extra">提示：请根据具体需求设置对应大小的图片，高清需要上传双倍大小</div>
                    </el-form-item>
                    <el-form-item v-if="decorateSn != 'investmentPromotionHomepage'" label="流程描述" prop="content">
                        <div class="relative">
                            <Editor v-model:html="formState.content" height="300px"></Editor>
                            <BusinessData v-model:modelValue="formState.content" :dataType="9" type="editor"></BusinessData>
                        </div>
                    </el-form-item>

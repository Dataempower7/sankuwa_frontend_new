            ...
            <el-form-item label="规格明细" prop="productList">
                <div class="lyecs-form-table">
                    <el-table :data="productList" style="width: 100%">
                        ...
                        <el-table-column prop="skuSn" label="商品编码" align="center" width="180">
                            <template #default="{ row, $index }">
                                {{ row.skuSn || "-" }}
                            </template>
                        </el-table-column>
                        <el-table-column prop="skuTsn" label="商品条形码" align="center" width="180">
                            <template #default="{ row, $index }">
                                {{ row.skuTsn || "-" }}
                            </template>
                        </el-table-column>
                        <el-table-column prop="supplyPrice" label="供货价" align="center" width="150">
                            <template #default="{ row, $index }">
                                {{ row.supplyPrice || "-" }}
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column prop="skuPrice" label="售价" width="180">
                            <template #default="{ row, $index }">
                        ...
                        <el-table-column prop="skuStock" label="库存" align="center" width="150">
                            <template #header>
...
const getProductForm = () => {
    ...
    for (let idx in list) {
        ...
        if (match) {
            ...
            res[idx].vendorProductSkuId = match.vendorProductSkuId;
            res[idx].maxPrice = match.maxPrice;
        }
    }
    // 用于匹配修改后的值

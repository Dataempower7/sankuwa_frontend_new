<template>
    ...
    <VendorAttr v-if="!loading && formState.productType !== 3" ref="attrForm"
        v-model:attrChanged="formState.attrChanged" v-model:attrList="formState.attrList"
        v-model:productList="formState.productList" v-model:skuErrorText="skuErrorText" :action="action"
        :attrTplList="attrTplList"></VendorAttr>
        ...
        <el-radio-group v-model="isLimit"
            ...
            <el-radio :value="true">
                <div class="flex">
                    ...
                    <TigInput v-model="formState.limitNumber" :disabled="!isLimit" placeholder="请输入限购数量" type="integer"
                        width="200px" />

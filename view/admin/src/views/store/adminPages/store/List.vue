                            ...
                            <div class="simple-form-warp">
                                <div class="simple-form-field">
                                    <div class="form-group">
                                        <label class="control-label"><span>门店名称：</span></label>
                    ...
                    <div class="table-container">
                        <a-spin :spinning="loading">
                            ...
                            >
                                ...
                                <!-- <el-table-column label="门店佣金" align="center">
                                    <template #default="{ row }">
                                        {{ row.shopCommission || '--'}}
                                    </template>
                                </el-table-column> -->
                                <el-table-column label="主账号" align="center">
                                    <template #default="{ row }">
                                        <div v-if="row.merchant && row.merchant.admin">
                                            <DialogForm
                                                :params="{ id: row.shopId, type: 'store' }"
                                                isDrawer
...
const handleSwitchChange = (params: any) => {
    ...
    ElMessageBox.confirm("确认修改当前门店的开业状态吗?", "提示", { confirmButtonText: "确认", cancelButtonText: "取消", type: "warning" })
        .then(() => {
...
onMounted(() => {
    if (query.id) {
        ElMessageBox.confirm(`为[${query.companyName || "--"}]立即创建门店?`, "提示", {

            ...
            <div class="lyecs-table-list-warp">
                            ...
                            <div class="simple-form-warp">
                                <div class="simple-form-field">
                                    <div class="form-group">
                                        <label class="control-label"><span>{{ isStore() ? "门店" :
                                            "店铺" }}名称：</span></label>
                                        <div class="control-container">
                                            <TigInput v-model="filterParams.keyword" name="keyword"
                                                :placeholder="(isStore() ? '门店' : '店铺') + '名称'"
                                ...
                                <div class="simple-form-field">
                                    <div class="form-group">
                                        <label class="control-label"><span>选择{{ isStore() ? '门店' : '店铺'
                                                }}：</span></label>
                                        <div class="control-container">
                                            <SelectVendorShop v-model:shopId="filterParams.shopId"
                                                @onChange="onSearchSubmit"></SelectVendorShop>
                                        </div>
                                    </div>
                                </div>
                                <div class="simple-form-field">
                                    <div class="form-group">
                                        ...
                                        <div class="control-container">
                                            <SelectVendorMerchant v-model:merchantId="filterParams.merchantId"
                                                @onChange="onSearchSubmit">
                                            </SelectVendorMerchant>
                                        </div>
                                    </div>
                                </div>
                                <div class="simple-form-field">
                ...
                <div class="table-container">
                    <a-spin :spinning="loading">
                        <el-table :data="filterState" row-key="shopId" :total="total" @sort-change="onSortChange"
                            :loading="loading">
                            ...
                            <el-table-column prop="shopTitle" :min-width="150">
                                <template #header>
                                    <span>{{ isStore() ? '门店' : '店铺' }}名称</span>
                                </template>
                            ...
                            <el-table-column prop="shopTitle" :min-width="150">
                                <template #header>
                                    <span>{{ isStore() ? '门店' : '店铺' }}LOGO</span>
                                </template>
                                <template #default="{ row }">
                                    <Image v-if="row.shopLogo" :src="imageFormat(row.shopLogo)" fit="contain"
                            ...
                            <el-table-column label="上架商品数" prop="upProductCount" width="150" sortable="custom">
                            </el-table-column>
                            <el-table-column label="下架商品数" prop="downProductCount" width="150" sortable="custom">
                            </el-table-column>
                            <el-table-column label="订单量" prop="orderCount" width="150" sortable="custom">
                            </el-table-column>
                            ...
                            <el-table-column label="操作" fixed="right" :width="170">
                                <template #default="{ row }">
                                    <DialogForm isDrawer @okCallback="loadFilter" title="查看订单" width="850px"
                                        path="vendor/supplier/bindShop/Order" :params="{ shopId: row.shopId }">
                                        <a class="btn-link">查看订单</a>
                                    </DialogForm>
                                    <el-divider direction="vertical" />
                                    <DialogForm isDrawer @okCallback="loadFilter" title="查看商品" width="850px"
                                        path="vendor/supplier/bindShop/Product" :params="{ shopId: row.shopId }">

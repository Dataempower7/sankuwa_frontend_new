                        ...
                        <div class="simple-form-warp">
                            <div class="simple-form-field">
                                <div class="form-group">
                                    ...
                                    <div class="control-container">
                                        <TigInput v-model="filterParams.keyword" name="keyword" placeholder="订单号/收货人姓名"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="control-container">
                                        <el-select v-model="filterParams.orderStatus" clearable @change="onTabChange">
                                            <el-option v-for="item in orderStatusList" :label="item.label"
                            ...
                            <div class="simple-form-field">
                                <div class="form-group">
                                    ...
                                    <SelectTimeInterval v-model:end-date="filterParams.endDate"
                                        v-model:start-date="filterParams.startDate" :clearable="false" type="date"
                            ...
                            <thead>
                                <tr class="data-tr">
                                    <th colspan="6">
                                        ...
                                        <el-tooltip v-if="item.shopId > 0" :content="'订单来自店铺：' + item.shop.shopTitle"
                                            effect="light" placement="top">

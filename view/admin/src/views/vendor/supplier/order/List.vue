                            ...
                            <thead>
                                <tr class="data-tr">
                                    <th colspan="6">
                                        ...
                                        <el-tooltip v-if="item.shopId > 0 && isMerchant()" :content="'订单来自店铺：' + item.shop.shopTitle" effect="light" placement="top">
                                            <Tag :transparent="false" text="店铺"></Tag>
                                        </el-tooltip>
                                        <el-tooltip v-if="item.vendorId > 0 && isS2b2c()" :content="'订单来自供应商：' + item.vendorName" effect="light" placement="top">

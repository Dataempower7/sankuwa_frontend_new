                                        ...
                                        <el-dropdown>
                                            ...
                                            <template #dropdown>
                                                <el-dropdown-menu>
                                                    ...
                                                    <DeleteRecord
                                                        :params="{ id: row.vendorId }"
                                                        title="删除后供应商信息将无法恢复，请确认是否删除该供应商？"
...
import { Pagination, Switch, DeleteRecord } from "@/components/list";
import { useConfigStore } from "@/store/config";
import type { SuppliersFilterParams, SuppliersFilterState } from "@/types/vendor/suppliers";
import { getSuppliersList, updateSuppliersField, delSuppliers } from "@/api/vendor/suppliers";

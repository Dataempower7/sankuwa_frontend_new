<template>
    <view class="share">
        ...
        <poster v-if="showPoster" v-model="showPoster" :product-id="productId" :product-info="data"
            :product-price="productPrice" :grouponPromotionId="grouponPromotionId"
...
import poster from "@/pages/groupon/src/poster.vue";
import guide from "@/pages/groupon/src/guide.vue";

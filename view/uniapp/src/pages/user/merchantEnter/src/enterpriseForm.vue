                    ...
                    <up-form ref="firstFormRef" label-position="left" :model="firstForm" :rules="firstFormRules" label-width="100" error-type="toast">
                        ...
                        <template v-if="currentStep == 2">
                            ...
                            <up-form-item :required="true" :label="$t('性别') + '：'" prop="sex" >
                                <view class="sex-box">
                                    <up-radio-group v-model="firstForm.sex" style="width: 485rpx; justify-content: flex-end" placement="row">
...
const firstFormRules = {
    ...
    companyName: [
        ...
        createValidator(validateCompanyName, t("请输入有效的企业名称（2-100个字符）"))
    ],
    businessLicenseAddress: [
        ...
        createValidator(validateAddress, t("请输入有效的详细地址（5-200个字符）"))
    ],
    licenseAddrProvince: [
        {
            required: true,
    ...
    businessScope: [
        ...
        createValidator(validateBusinessScope, t("请输入有效的经营范围（5-200个字符）"))
    ],
    businessLicenseId: [
        {
            required: true,
        ...
        createValidator(validateUnifiedSocialCreditCode, t("请输入有效的统一社会信用代码（18位）"))
    ],
    operatingTermType: [
        {
            validator: (rule: any, value: any, callback: any) => {
